...
namespace WebSec.Common.TestInfrastructure
{
    ...
    {
        /// <summary>
        /// List of types of the signed.
        /// </summary>
        private static readonly Type[] SignedTypes = Array(typeof(sbyte), typeof(short), typeof(int), typeof(long));

        /// <summary>
        /// List of types of the unsigned.
        /// </summary>
        private static readonly Type[] UnsignedTypes = Array(typeof(bool), typeof(byte), typeof(ushort), typeof(uint), typeof(ulong));

        /// <summary>
        /// List of types of the integers.
        /// </summary>
        private static readonly Type[] IntegerTypes = Array(
            typeof(bool),
            typeof(sbyte),
            typeof(byte),
            typeof(short),
        ...
        /// <summary>
        /// List of types of the floats.
        /// </summary>
        private static readonly Type[] FloatTypes = Array(typeof(float), typeof(double), typeof(decimal));

        /// <summary>
        /// The extended primitives.
        /// </summary>
        private static readonly Type[] ExtendedPrimitives = Array(typeof(string), typeof(Guid), typeof(DateTime), typeof(TimeSpan));

        /// <summary>
        /// List of known types.
        /// </summary>
        private static readonly IEnumerable<Type> StaticKnownTypes = FindKnownTypes();

        /// <summary>
        /// Gets the types that provide extension methods.
        /// </summary>
        public static IEnumerable<Type> ExtensionTypes { get; private set; }

        /// <summary>
        /// Gets the known types within the system.
        /// </summary>
        public static IEnumerable<Type> KnownTypes => StaticKnownTypes;
        ...
        /// </returns>
        public static IEnumerable<Type> FindKnownTypes()
        {
            ...
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                try
                {
                    foreach (Type type in assembly.GetTypes())
                    {
                        ...
                        if (type.IsSealed)
                        {
                            if (type.GetMethods(BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)
        ...
        ///    The return value of the method invoked.
        /// </returns>
        public static object Invoke(this object instance, string methodName, Type nullType, params object[] parameters)
        {
            ...
            var bestMatch = LocateBestMatch<MethodInfo>(type, methodName, nullType, Bindings, parameters);
        ...
        ///    The return value of the method invoked.
        /// </returns>
        public static object Invoke(this Type type, string methodName, Type nullType, params object[] parameters)
        {
            const BindingFlags Bindings =
        ...
        ///    The return value of the method invoked.
        /// </returns>
        public static object Invoke(this Type type, string methodName, Type[] typeParameters, params object[] parameters)
        {
        ...
        ///    The return value of the method invoked.
        /// </returns>
        public static object Invoke(this Type type, string methodName, Type nullType, Type[] typeParameters, params object[] parameters)
        {
            const BindingFlags Bindings =
                BindingFlags.InvokeMethod | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic;
        ...
        /// <summary>
        ///    Sets any public or non-public property or field by name.
        /// </summary>
        /// <param name = "instance">
        ...
        ///    The value to be set.
        /// </param>
        public static void Set(this IDictionary<string, object> expando, string name, object value)
        {
            expando.As<IDictionary<string, object>>()[name] = value;
        }

        /// <summary>
        ///    Get's the value of a public or non-public property or field of an
        ...
        /// <summary>
        ///    Get's the value of a static public or non-public property or field of an
        ...
        ///    The value of the Field or Property.
        /// </returns>
        public static object Get(this IDictionary<string, object> expando, string name)
        {
        ...
        /// </returns>
        public static bool IsSigned(this Type inputValue)
        {
        ...
        /// </returns>
        public static bool IsUnsigned(this Type inputValue)
        {
        ...
        /// </returns>
        public static bool IsInteger(this Type inputValue)
        {
        ...
        /// True if the type is a numeric type otherwise false.
        /// </returns>
        public static bool IsFloatingPoint(this Type inputValue)
        {
        ...
        /// True if the type is a numeric type otherwise false.
        /// </returns>
        public static bool IsNumeric(this Type inputValue)
        {
        ...
        /// </returns>
        public static bool IsExtendedPrimitive(this Type inputValue)
        {
            Require.NotNull(() => inputValue);
            return inputValue.IsPrimitive || ExtendedPrimitives.Contains(inputValue);
        }

        /// <summary>
        /// Changes a SecureString into a string.
        /// </summary>
        /// <param name="inputValue">
        /// The secure string.
        /// </param>
        /// <returns>
        /// A string representing the contents of the original secure string.
        /// </returns>
        public static string ToPlaintextString(this SecureString inputValue)
        {
            string retval;
            IntPtr pointer = IntPtr.Zero;
            try
            {
                pointer = Marshal.SecureStringToGlobalAllocUnicode(inputValue);
                retval = Marshal.PtrToStringUni(pointer);
            }
            finally
            {
        ...
        /// </returns>
        public static string SubstringAfter(this string inputValue, string searchValue)
        {
            Require.NotNull(() => inputValue);
        ...
        /// the original string if the parse string was not found.
        /// </returns>
        public static string SubstringBefore(this string inputValue, string searchValue)
        {
            Require.NotNull(() => inputValue);
            int loc = inputValue.IndexOfOi(searchValue);
            if (loc >= 0)
        ...
        /// </returns>
        public static bool IsParamsParameter(this ParameterInfo parameterInfo)
        {
            Require.NotNull(() => parameterInfo);
            return
                parameterInfo.GetCustomAttributes(true).Where(a => a.GetType() == typeof(ParamArrayAttribute)).Count() >
                0;
        }

        /// <summary>
        /// Arrays the given input.
        /// </summary>
        /// <typeparam name="T">
        /// Generic type parameter.
        /// </typeparam>
        /// <param name="input">
        /// A variable-length parameters list containing input.
        /// </param>
        /// <returns>
        /// A T[].
        /// </returns>
        private static T[] Array<T>(params T[] input)
        {
            return input;
        }
        ...
        private static void Set(Type type, object instance, string name, object value)
        {
            ...
            MemberInfo info =
                type.GetMember(name, bindings | BindingFlags.GetField | BindingFlags.GetProperty).FirstOrDefault();

            if (info == null)
            {
                throw new MissingMemberException(string.Format(
                    CultureInfo.InvariantCulture,
                    "The member {0} does not exist", 
                    name));
            }
        ...
        /// <summary>
        ///    Get's a public or non-public property of an object given
        ...
        /// </returns>
        private static object InternalDynaCreate(
            Type concreteType, 
            Type nullType,
            ...
            object[] parameters)
        {
            ...
            var bestMatch = LocateBestMatch<ConstructorInfo>(concreteType, null, nullType, bindings, parameters);
        ...
        /// <summary>
        /// Determines the compatibility of a match between a set of supplied parameters and a set of
        /// possible parameters for an overloaded function.
        /// </summary>
        /// <param name="parameters">
        /// A set of ParameterInfo objects representing the available parameters for an overload of a
        /// method.
        /// </param>
        /// <param name="values">
        /// A set of objects representing a intended set of values to be supplied to an overload for an
        /// object.
        /// </param>
        /// <param name="nullType">
        /// The type to use if a parameter is null.
        /// </param>
        /// <returns>
        /// A numerical indicator of the compatibility between a possible parameter set and a supplied
        /// set of objects.  The higher this indicator the stronger the match.
        /// </returns>
                ...
                if (i < paramCount && i < objCount)
                {
                    ...
                    if (
                        info.GetCustomAttributes(true)
                            .Where(a => a.GetType().IsAssignableFrom(typeof(ParamArrayAttribute)))
                            .Count() > 0)
                    {
                        ...
                        if (infoElementType.ContainsGenericParameters)
                        {
                            ...
                            if (genericParameterConstraints.Count() == 0 ||
                                genericParameterConstraints.Any(
                                    constraint => constraint.IsAssignableFrom(objElementType)))
                            {
                                retval += 3;
                            }
                        }
        ...
        ///    parameters.
        /// </returns>
        private static T LocateBestMatch<T>(
            Type type,
            string name, 
            Type nullType, 
            BindingFlags bindings,
            object[] parameters) where T : MethodBase
        {
            ...
            if (typeof(MethodInfo).IsAssignableFrom(typeof(T)))
            {
                ...
                IEnumerable<MethodInfo> extensionMethods = ExtensionTypes.SelectMany(t => t.GetMethods())
                ...
                extensions =
                    sameNamedExtensionMethods.Where(m => m.GetParameters()[0].ParameterType.IsAssignableFrom(type))
                        .Cast<T>();
            ...
            foreach (var info in infos)
            {
                ...
                // "could work".
                int score = CompareTypeAssignments(info.GetParameters(), parameters, nullType);
                if (score > bestScore)
                {
                    bestScore = score;
                    bestMatch = info;
            ...
            if (bestMatch.IsNull() && extensions.IsNotNull() && typeof(MethodInfo).IsAssignableFrom(typeof(T)))
            {
                foreach (var info in extensions)
                {
                    ...
                    // This avoids unnecessary ambiguity errors when multiple members
                    // "could work".
                    int score = CompareTypeAssignments(info.GetParameters().Skip(1).ToArray(), parameters, nullType);
                    if (score > bestScore)
                    {
                        bestScore = score;
                        bestMatch = info;
        ...
        private static object InternalDynaInvoke(MethodBase method, object[] parameters, object instance = null)
        {
            try
            {
                ...
                {
                    return method.Invoke(null, Array(instance).Union(parameters).ToArray());
                }
            ...
            catch (TargetInvocationException ex)
            {
                ...
                // of an exception.
                FieldInfo remoteStackTrace = typeof(Exception).GetField(
