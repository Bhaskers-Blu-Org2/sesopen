...
namespace WebSec.Plugins.Tests
{
    ...
    /// <summary>
    /// The cache control cache control meta tests.
    /// </summary>
    [TestClass]
    public class CacheControlMetaTests : PluginTestBase<CacheControlMetaDetector>
    {
        /// <summary>
        /// Class cleanup.
        /// </summary>
        ...
        public void CacheControlPositive()
        {
            ...
            // Instead we inject the content via the pre-inspection hook.
            this.DetectorPreInspectionAction =
                () =>
                {
                    this.ResponseHolder.ResponseContent =
                        "<html><head> <meta http-equiv=\"Cache-Control\" content=\"public\"> </head><body/></html>";
                };
            ...
            vuln.Evidence.ShouldEqual("<meta http-equiv=\"Cache-Control\" content=\"public\">");
        }
        ...
        public void CacheControlNegativeNoStore()
        {
            ...
            this.DetectorPreInspectionAction =
                ...
                {
                    this.ResponseHolder.ResponseContent =
                        "<html><head> <meta http-equiv=\"Cache-Control\" content=\"no-store\"> </head><body/></html>";
                };
        ...
        public void CacheControlNegativeUnspecified()
        {
            ...
            this.DetectorPreInspectionAction =
                ...
                {
                    this.ResponseHolder.ResponseContent =
                        "<html><head> <meta http-equiv=\"test\" content=\"test\"> </head><body/></html>";
                };
