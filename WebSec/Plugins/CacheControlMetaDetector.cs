                ...
                if (metaElements != null)
                {
                    foreach (HtmlNode metaElement in metaElements)
                    {
                        ...
                        if (httpEquiv.Equals("cache-control", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ...
                            if (content.Equals("no-cache", StringComparison.InvariantCultureIgnoreCase)
                                || content.Equals("private", StringComparison.InvariantCultureIgnoreCase)
                                || content.Equals("public", StringComparison.InvariantCultureIgnoreCase))
                            {
